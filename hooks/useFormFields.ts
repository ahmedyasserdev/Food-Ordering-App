...
import { IFormField, IFormFieldsVariables, Translations } from "@/types";

interface useFormFieldsProps extends IFormFieldsVariables {
    translations : Translations;

}

export const useFormFields = ({slug , translations} : useFormFieldsProps) => {
